    ...
    <div className="min-h-screen bg-gradient-to-br from-[#EDE6E3] via-[#DADAD9] to-[#EDE6E3] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#36382E] mb-2">Welcome Back</h1>
          <p className="text-[#36382E]/70">Sign in to continue your job search</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border-2 border-[#DADAD9]">
          ...
          >
            ...
            <span className="text-[#36382E] font-medium">Sign in with Google</span>
          </button>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-[#36382E]/60">Or sign in with email</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-[#36382E] font-medium mb-2">Password</label>
              <div className="relative">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-4 w-4 rounded border-[#DADAD9] text-[#5BC3EB] focus:ring-[#5BC3EB]"
                />
                <label htmlFor="rememberMe" className="text-sm text-[#36382E]/70">
                  Remember me
                </label>
              </div>
              <Link to="/forgot" className="text-sm text-[#5BC3EB] hover:underline font-medium">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-[#36382E]/70">
              ...
              <Link to={"/sign"} className="text-[#5BC3EB] hover:underline font-medium">
                Sign Up
              </Link>
            </p>
          </div>
