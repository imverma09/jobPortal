            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-[#36382E] mb-1">
                    {app?.job?.jobtitle}
                  </h3>
                  <p className="text-[#36382E]/70 font-medium mb-2">
                    {app?.job?.companyName}
                  </p>
              ...
              <div className="flex flex-col items-end space-y-2">
                <span
                  className={`px-4 py-2 rounded-lg text-sm font-bold border flex items-center space-x-2 ${getStatusColor(app.status)}`}
                >
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="p-2 text-[#F06449] hover:bg-[#F06449]/10 rounded-lg transition-colors"
                  >
